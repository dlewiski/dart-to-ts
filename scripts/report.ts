...
function calculatePackageComplexity(packages: any[]): Record<string, number> {
...
function calculateTechDebtScore(techDebt: any[]): number {
...
function calculateDependencyReduction(decisions: any[]): number {
...
function getCriticalDebts(techDebt: any[]): any[] {
  return techDebt
...
async function outputMarkdown(report: any, outputDir: string) {
...
async function outputHTML(report: any, outputDir: string) {
...
async function generateComparisonReport(beforePath: string, outputDir: string) {
  try {
